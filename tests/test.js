...
describe("store / get / delete string in 2 LEVEL cache", () => {
  const cache = new lrufiles({
    level: 2,
    dir: "cache_l2", 			// directory to store caches files
  	files: 3,       // maximum number of files
  	size: "1 GB",     // maximum total file size
  	check: 10,  // interval of stale checks in minutes
  });
...
describe("set two buffers and clear entire 2 LEVEL cache", () => {
  const cache = new lrufiles({
    level: 2,
    dir: "cache_l2", 			// directory to store caches files
  	files: 3,       // maximum number of files
...
describe("non-existent cache operations on 2 LEVEL cache", () => {
  const cache = new lrufiles({
    level: 2,
    dir: "cache_l2", 			// directory to store caches files
  	files: 3,       // maximum number of files
...
describe("write many files and check stale cache cleaner in 2 LEVEL cache", () => {
  const bigcache = new lrufiles({
    level: 2,
    dir: "bigcache_l2", 			// directory to store caches files
  	files: 3,       // maximum number of files
  	size: 12,     // maximum total file size
  	check: 10,  // interval of stale checks in minutes
  });
...
describe("testing cron job in LEVEL 2 cache", () => {
  const bigcache = new lrufiles({
    level: 2,
